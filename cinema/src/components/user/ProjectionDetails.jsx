  ...
  simulatingPayment() {
    ...
    fetch(`${serviceConfig.baseURL}/api/Levi9Payment`, requestOptions)
      ...
      .catch(response => {
        ...
        NotificationManager.info('You will be redirected to seat reservation shortly.');
          ...
          <Col>
            <Card className="mt-5 card-width">
              <Card.Body>
                ...
                <hr />
                <Card.Subtitle className="mb-2 text-muted">Time of Projection: {projectionTime} <Card align='right' ><img className="img-responsive" src="https://source.unsplash.com/random" alt="logo" width="350" height="200" />
                </Card></Card.Subtitle>
                <hr />
                <Card.Text>
                  <Row className="mt-2">
